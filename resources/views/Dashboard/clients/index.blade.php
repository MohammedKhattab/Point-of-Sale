                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('orders_create'))
                                             <a href="{{route('dashboard.clients.orders.create',$client->id)}}" class="btn btn-info btn-sm"><i class="fa fa-add"></i> @lang('site.add_order')</a>
                                        @else
                                        <a href="#" class="btn btn-info btn-sm disabled"><i class="fa fa-add"></i> @lang('site.add_order')</a>
                                        @endif
